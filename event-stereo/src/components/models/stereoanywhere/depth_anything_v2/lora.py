...
#https://github.com/RobvanGastel/dinov3-finetune/blob/main/dino_finetune/model/lora.py
class LoRA(nn.Module):
    ...
    def forward(self, x) -> torch.Tensor:
        ...
        # print("qkv first ten weights:", self.qkv.weight.flatten()[:10])
        # print("LoRA A Q first ten weights:", self.linear_a_q.weight.flatten()[:10])
