...
class EventDataset(torch.utils.data.Dataset):
    ...
    def __init__(self, root, seq_name, num_of_event, stack_method, **kwargs):
        self.root = root
        ...
        for location in self._LOCATION:
            self.event_slicer[location] = EventSlicer(root=self.root, seq_name=self.seq_name, num_of_event=self.num_of_event, width=constant.EVENT_WIDTH, height=constant.EVENT_HEIGHT, location=location)
