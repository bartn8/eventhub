...
class EventDataset(torch.utils.data.Dataset):
    ...
    def __init__(self, root, num_of_event, stack_method, **kwargs):
        ...
        for location in self._LOCATION:
            self.stack_function[location] = getattr(stack, stack_method)(num_of_event=num_of_event, height=constant.EVENT_HEIGHT, width=constant.EVENT_WIDTH, dropout_rnd_state=self.dropout_rnd_state, noise_rnd_state=self.noise_rnd_state, **kwargs)
